# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 16:25:17 2023
...
Folder2 = "Data/Meta data/Control group C"
Folder3 = "Data/Normalized data"
Folder4 = "Data/Enrichment data/Control group C"

Folder5 = "Results/PCA/Age/Individual groups/Control"
os.makedirs(Folder5,exist_ok=True)

## Files ##

File1 = "Meta_data_groups.xlsx"
File2 = "Metadata_control_group_C_overview.csv"
File3 = "Group C Normalized data.xlsx"
...
df_data = df_data.rename(columns={'Unnamed: 0':"Sample number"})
...
#df_enrichment_data_interest =  pd.read_csv(os.path.join(Folder4,File5),sep=";")
...
for Group in Group_list_all:
    try:
        ...
        target_names = {
            1:'Less or equal 60-years',
            0:'Over 60-years'
        }
        
        pca_df['Age'] = df_metadata['Age targets']
