# -*- coding: utf-8 -*-
"""
Created on Mon Dec  5 14:46:48 2022
...
File2 = "raw_data_C_and_D_transposed.csv"
...
# Read data #
df_Compounds = pd.read_csv(os.path.join(Folder2,File2),sep=";")
## exclude non-lipids ##

df_Compounds = df_Compounds[df_Compounds["Name"].isin(df_groups_Compounds_of_interest["Compounds"])]

# Create list of Compounds #
Metabolite_list = df_Compounds['Name'].tolist()
...
# Add the specific rows at the end of the dataframe #
#df_Enrichment_all_sorted = pd.concat([df_Enrichment_all, df_Enrichment_specific], ignore_index=True)
