# -*- coding: utf-8 -*-
"""
Created on Thu Jan 26 10:45:47 2023
...
Age_mapping = dict(df_metadata[['Sample number', 'Age']].values)
...
df_data = df_data.reset_index().rename(columns={"Sample number":'Age'}).replace({'Age':Age_mapping}).set_index('Age')
