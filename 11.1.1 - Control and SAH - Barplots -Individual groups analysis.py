# -*- coding: utf-8 -*-
"""
Created on Thu Feb  2 07:43:41 2023
...
File3 = "Enrichement_data_all_group_C.csv"
...
for Group in Group_list_interest:
    ...
    """
    df_individual_group = pd.concat([df_individual_group.set_index("Compounds"),df_overview.set_index("Compounds")[['Group C Mean','Group C SD','Group D Mean','Group D SD']]],join='inner',axis=1)
    if Group == "Triacylglyceols":
        #df_individual_group = pd.concat([df_individual_group.set_index("Compounds"),df_overview.set_index("Compounds")],join='inner')
        break
    """
    df_individual_group.drop(df_individual_group[df_individual_group.Padj >= 0.1].index, inplace=True)
